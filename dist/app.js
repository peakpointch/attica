...
(0, _core.onReady)(()=>{
    (0, _navbar.initNavAnimation)();
});

},{"@xatom/core":"8w4K8","./modules/navbar":"ckHfz"}],"8w4K8":[function(require,module,exports,__globalThis) {
...
},{"./validate.js":"dfZI5","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"ckHfz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hideNavCTA", ()=>hideNavCTA);
parcelHelpers.export(exports, "showNavCTA", ()=>showNavCTA);
parcelHelpers.export(exports, "navToLight", ()=>navToLight);
parcelHelpers.export(exports, "navToDefault", ()=>navToDefault);
parcelHelpers.export(exports, "initNavAnimation", ()=>initNavAnimation);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
// import { createAttribute } from "peakflow";
var _index = require("../../node_modules/peakflow/dist/attributeselector/index");
const animateSelector = (0, _index.createAttribute)("data-animate");
function hideNavCTA(nav) {
    if (!nav) throw new Error(`Please pass a navbar to animate.`);
    const navComponents = nav instanceof HTMLElement ? [
        nav
    ] : Array.from(nav);
    navComponents.forEach((component)=>{
        const button = component.querySelector(".button");
        (0, _gsap.gsap).to(button, {
            translateY: "-5rem",
            ease: "power1.out",
            duration: 0.2
        });
...
function navToLight(nav) {
    ...
    navComponents.forEach((component)=>{
        ...
        buttons.forEach((button)=>{
            button.setAttribute("data-wf--button-icon-external--variant", "alternate");
...
function navToDefault(nav) {
    ...
    navComponents.forEach((component)=>{
        const buttons = component.querySelectorAll(".button");
        buttons.forEach((button)=>{
            button.setAttribute("data-wf--button-icon-external--variant", "secondary");
...
function initNavAnimation() {
    ...
    const navComponents = Array.from(document.querySelectorAll(animateSelector("nav-component")));
    const lightSections = Array.from(document.querySelectorAll(animateSelector("light-nav")));
    const brandElements = Array.from(document.querySelectorAll(animateSelector("top-brand")));
    ...
    const anyLightSection = Array.from(lightSections).some((el)=>(0, _scrollTrigger.ScrollTrigger).isInViewport(el, 0.5));
    if (anyLightSection) {
        navToLight(navComponents);
        navIsLight = true;
    } else {
    ...
    const anyBrandNav = Array.from(brandElements).some((el)=>(0, _scrollTrigger.ScrollTrigger).isInViewport(el, 0.2));
    if (anyBrandNav) {
        hideNavCTA(navComponents);
        navButtonIsHidden = true;
    } else {
...
},{"gsap":"33IqQ","gsap/ScrollTrigger":"5ubnS","../../node_modules/peakflow/dist/attributeselector/index":"8j6ig","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"33IqQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"8j6ig":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>(0, _attributeselectorJs.createAttribute));
var _attributeselectorJs = require("./attributeselector.js");
parcelHelpers.exportAll(_attributeselectorJs, exports);

},{"./attributeselector.js":"9KX2L","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"9KX2L":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
const createAttribute = (attrName, defaultOptions)=>{
    ...
    return (name = mergedDefaultOptions.defaultValue, options)=>{
        ...
        if (!name) return exclude(`[${attrName}]`, ...mergedOptions.exclusions);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["jeTtx"], "jeTtx", "parcelRequireedee", {})
